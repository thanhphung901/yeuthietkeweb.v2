<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site.Master" AutoEventWireup="true" CodeBehind="user_list.aspx.cs" Inherits="yeuthietkeweb.cms.pages.user_list" %>
                    ...
                    <div class="dataTable_wrapper">
                        <div class="form-group">
                            <table id="tblFilter">
                                <tr>
                                    <td>
                                        <a href="user.aspx" class="btn btn-default btn-success btn-sm">Thêm mới</a>
                                    </td>
                                    <td>
