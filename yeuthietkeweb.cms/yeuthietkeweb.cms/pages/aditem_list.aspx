<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site.Master" AutoEventWireup="true" CodeBehind="aditem_list.aspx.cs" Inherits="yeuthietkeweb.cms.pages.aditem_list" %>
                    ...
                    <div class="dataTable_wrapper">
                        <div class="form-group">
                            <table id="tblFilter">
                                <tr>
                                    <td>
                                        <a href="aditem.aspx" class="btn btn-default btn-success btn-sm">Thêm mới</a>
                                    </td>
                                    <td>
                                ...
                                <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
                                    <ItemTemplate>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                <a href='<%# getLink(DataBinder.Eval(Container.DataItem, "AD_ITEM_ID")) %>'><span class="glyphicon glyphicon-pencil"></span></a>
                                            </td>
                                            <td class="center">
