...
<div id="body">
    ...
    <input type="text" id="queryinput" size="60" class="form-control" placeholder="Nội dung tìm kiếm" /> <input id="search_youtube" type="submit" value="Tìm kiếm" class="btn-default" />
    <br /><br />
    ...
    <div>
        <div style="float:left;">
            ...
            <button id="youtube_cancel" class="btn-default">Thoát</button> <button id="youtube_insert" class="btn-primary">Chèn và đóng</button>
        </div>
        <div style="float:left;">
        </div>
    </div>
